...
class BucketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bucket" do
    assert_difference('Bucket.count') do
      post buckets_url, params: { bucket: { product_id: @bucket.product_id, user_id: @bucket.user_id } }
    end
  ...
  test "should update bucket" do
    patch bucket_url(@bucket), params: { bucket: { product_id: @bucket.product_id, user_id: @bucket.user_id } }
